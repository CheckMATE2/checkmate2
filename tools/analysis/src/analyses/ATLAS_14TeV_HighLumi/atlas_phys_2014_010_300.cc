...
std::string Atlas_phys_2014_010_300::nameSR[10] = {"a.2jl", "b.2jm", "c.3j", "d.4jl", "e.4jm", "f.4jt", "g.5j", "h.6jl", "i.6jm", "j.6jt"};

void Atlas_phys_2014_010_300::initialize() {
  setAnalysisName("atlas_phys_2014_010_300");          
  setInformation(""
...
void Atlas_phys_2014_010_300::analyze() {
...
//  !!!!!!!!!!!!!!!!!!!!!!!!!!  (possibly a typo in table 7 for meff)
...
//for signal region 6jl
  if ( flag6J && missingET->P4().Et() / meff6J > 0.3 ) {
...
void Atlas_phys_2014_010_300::finalize() {

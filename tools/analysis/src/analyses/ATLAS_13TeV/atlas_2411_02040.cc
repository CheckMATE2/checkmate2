...
void Atlas_2411_02040::analyze() {
  ...
  if (bjets5) {
    ...
    if (resDNN_Score > 0.05 and nonresDNN_Score < 0.1) countControlEvent("resDNN-CR-bin00");
    else if (resDNN_Score > 0.1 and nonresDNN_Score < 0.15) countControlEvent("resDNN-CR-bin01");
    else if (resDNN_Score > 0.15 and nonresDNN_Score < 0.2) countControlEvent("resDNN-CR-bin02");
    else if (resDNN_Score > 0.2 and nonresDNN_Score < 0.25) countControlEvent("resDNN-CR-bin03");
    else if (resDNN_Score > 0.25 and nonresDNN_Score < 0.3) countControlEvent("resDNN-CR-bin04");
    else if (resDNN_Score > 0.3 and nonresDNN_Score < 0.35) countControlEvent("resDNN-CR-bin05");
    else if (resDNN_Score > 0.35 and nonresDNN_Score < 0.4) countControlEvent("resDNN-CR-bin06");
    else if (resDNN_Score > 0.4 and nonresDNN_Score < 0.45) countControlEvent("resDNN-CR-bin07");
    else if (resDNN_Score > 0.45 and nonresDNN_Score < 0.5) countControlEvent("resDNN-CR-bin08");
    else if (resDNN_Score > 0.5 and nonresDNN_Score < 0.55) countControlEvent("resDNN-CR-bin09");
    else if (resDNN_Score > 0.55 and nonresDNN_Score < 0.6) countControlEvent("resDNN-CR-bin10");
    else if (resDNN_Score > 0.6 and nonresDNN_Score < 0.65) countControlEvent("resDNN-CR-bin11");
    else if (resDNN_Score > 0.65 and nonresDNN_Score < 0.7) countControlEvent("resDNN-CR-bin12");
    else if (resDNN_Score > 0.7 and nonresDNN_Score < 0.75) countControlEvent("resDNN-CR-bin13");
    else if (resDNN_Score > 0.75 and nonresDNN_Score < 0.8) countControlEvent("resDNN-CR-bin14");
    else if (resDNN_Score > 0.8 and nonresDNN_Score < 0.85) countControlEvent("resDNN-CR-bin15");
    else if (resDNN_Score > 0.85 and nonresDNN_Score < 0.9) countControlEvent("resDNN-CR-bin16");
    else if (resDNN_Score > 0.9 and nonresDNN_Score < 0.95) countControlEvent("resDNN-CR-bin17");
    else if (resDNN_Score > 0.95 ) countControlEvent("resDNN-CR-bin18");
    
    if (heavyresDNN_Score > 0.1 and nonresDNN_Score < 0.15) countControlEvent("heavyresDNN-CR-bin00");
    else if (heavyresDNN_Score > 0.15 and nonresDNN_Score < 0.2) countControlEvent("heavyresDNN-CR-bin01");
    else if (heavyresDNN_Score > 0.2 and nonresDNN_Score < 0.25) countControlEvent("heavyresDNN-CR-bin02");
    else if (heavyresDNN_Score > 0.25 and nonresDNN_Score < 0.3) countControlEvent("heavyresDNN-CR-bin03");
    else if (heavyresDNN_Score > 0.3 and nonresDNN_Score < 0.35) countControlEvent("heavyresDNN-CR-bin04");
    else if (heavyresDNN_Score > 0.35 and nonresDNN_Score < 0.4) countControlEvent("heavyresDNN-CR-bin05");
    else if (heavyresDNN_Score > 0.4 and nonresDNN_Score < 0.45) countControlEvent("heavyresDNN-CR-bin06");
    else if (heavyresDNN_Score > 0.45 and nonresDNN_Score < 0.5) countControlEvent("heavyresDNN-CR-bin07");
    else if (heavyresDNN_Score > 0.5 and nonresDNN_Score < 0.55) countControlEvent("heavyresDNN-CR-bin08");
    else if (heavyresDNN_Score > 0.55 and nonresDNN_Score < 0.6) countControlEvent("heavyresDNN-CR-bin09");
    else if (heavyresDNN_Score > 0.6 and nonresDNN_Score < 0.65) countControlEvent("heavyresDNN-CR-bin10");
    else if (heavyresDNN_Score > 0.65 and nonresDNN_Score < 0.7) countControlEvent("heavyresDNN-CR-bin11");
    else if (heavyresDNN_Score > 0.7 and nonresDNN_Score < 0.75) countControlEvent("heavyresDNN-CR-bin12");
    else if (heavyresDNN_Score > 0.75 and nonresDNN_Score < 0.8) countControlEvent("heavyresDNN-CR-bin13");
    else if (heavyresDNN_Score > 0.8 and nonresDNN_Score < 0.85) countControlEvent("heavyresDNN-CR-bin14");
    else if (heavyresDNN_Score > 0.85 and nonresDNN_Score < 0.9) countControlEvent("heavyresDNN-CR-bin15");
    else if (heavyresDNN_Score > 0.9 and nonresDNN_Score < 0.95) countControlEvent("heavyresDNN-CR-bin16");

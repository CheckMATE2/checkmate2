...
class Atlas_1911_12606 : public AnalysisBase {
  ...
  private:
    ...
    std::vector<FinalStateObject*> leptons_tracks;
    ...
    std::vector<Electron> electrons_tracks_true;
    std::vector<Muon> muons_tracks_true;
    int nb, flavour;
    ...
    std::vector<FinalStateObject*> Isolate_tracks(std::vector<FinalStateObject*> cand_tracks, double dR, double mom);

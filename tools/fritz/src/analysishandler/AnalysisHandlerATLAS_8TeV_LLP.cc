/*
 * AnalysisHandlerATLAS_8TeV_LLP.cc
 *
 *  Created on: Feb 23, 2015
 *      Author: daschm
 */

#include "AnalysisHandlerATLAS_8TeV_LLP.h"

const double AnalysisHandlerATLAS_8TeV_LLP::DR_TAU_TRACK = 0.2;
const double AnalysisHandlerATLAS_8TeV_LLP::PTMIN_TAU_TRACK = 1.0;

const double AnalysisHandlerATLAS_8TeV_LLP::DR_TAU_TRUTH = 0.2;
const double AnalysisHandlerATLAS_8TeV_LLP::ETAMAX_TAU_TRUTH = 2.5;
const double AnalysisHandlerATLAS_8TeV_LLP::PTMIN_TAU_TRUTH = 10.0;

const double AnalysisHandlerATLAS_8TeV_LLP::DR_B_TRUTH = 0.4;
const double AnalysisHandlerATLAS_8TeV_LLP::ETAMAX_B_TRUTH = 2.5;
const double AnalysisHandlerATLAS_8TeV_LLP::PTMIN_B_TRUTH = 1.0;

AnalysisHandlerATLAS_8TeV_LLP::AnalysisHandlerATLAS_8TeV_LLP() : AnalysisHandler() {
}

AnalysisHandlerATLAS_8TeV_LLP::~AnalysisHandlerATLAS_8TeV_LLP() {
}

void AnalysisHandlerATLAS_8TeV_LLP::initialize() {
}

void AnalysisHandlerATLAS_8TeV_LLP::finalize() {
}

void AnalysisHandlerATLAS_8TeV_LLP::bookAnalysis(std::string analysisName,
                                        Tag_Map whichTags,
...
void AnalysisHandlerATLAS_8TeV_LLP::postProcessParticles() {
...
void AnalysisHandlerATLAS_8TeV_LLP::identifyPhotons() {
    double pEffMed = 0;
    Photon* cand = NULL;
...
void AnalysisHandlerATLAS_8TeV_LLP::identifyElectrons() {
...
void AnalysisHandlerATLAS_8TeV_LLP::identifyMuons()  {
...
void AnalysisHandlerATLAS_8TeV_LLP::tagBJets() {
   ...
   for(int j = 0; j < jets.size(); j++) {
              ...
              if(true_b[b]->PT > PTMIN_B_TRUTH &&
                fabs(true_b[b]->Eta) < ETAMAX_B_TRUTH &&
                 true_b[b]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                  eff_function = &AnalysisHandlerATLAS_8TeV_LLP::bSigEff;
                  break;
              }
          }
              ...
              for(int c = 0; c < true_c.size(); c++) {
                  if(true_c[c]->PT > PTMIN_B_TRUTH &&
                     ...
                     true_c[c]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                      eff_function = &AnalysisHandlerATLAS_8TeV_LLP::bBkgCJetEff;
                      break;
                  }
              }
          }
          ...
          if (eff_function == NULL)
              eff_function = &AnalysisHandlerATLAS_8TeV_LLP::bBkgLJetEff;
...
void AnalysisHandlerATLAS_8TeV_LLP::tagTauJets() {
    ...
    for(int j = 0; j < jets.size(); j++) {
       ...
       for(int t = 0; t < true_tau.size(); t++) {
           if(true_tau[t]->PT > PTMIN_TAU_TRUTH &&
              ...
              cand->P4().DeltaR(true_tau[t]->P4()) < DR_TAU_TRUTH) {
               if(prongs > 1) {
                   effFunLoose = &AnalysisHandlerATLAS_8TeV_LLP::tauSigEffMultiLoose;
                   effFunMedium = &AnalysisHandlerATLAS_8TeV_LLP::tauSigEffMultiMedium;
                   effFunTight = &AnalysisHandlerATLAS_8TeV_LLP::tauSigEffMultiTight;
               }
               else {
                   effFunLoose = &AnalysisHandlerATLAS_8TeV_LLP::tauSigEffSingleLoose;
                   effFunMedium = &AnalysisHandlerATLAS_8TeV_LLP::tauSigEffSingleMedium;
                   effFunTight = &AnalysisHandlerATLAS_8TeV_LLP::tauSigEffSingleTight;
               }
               break;
           }
       }
       ...
       if(effFunLoose == NULL) {
           if(prongs > 1) {
               effFunLoose = &AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffMultiLoose;
               effFunMedium = &AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffMultiMedium;
               effFunTight = &AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffMultiTight;
           }
           else {
               effFunLoose = &AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffSingleLoose;
               effFunMedium = &AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffSingleMedium;
               effFunTight = &AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffSingleTight;
           }
       }
       // Now that we know the right function to use, lets tag
...
void AnalysisHandlerATLAS_8TeV_LLP::linkObjects() {
...
double AnalysisHandlerATLAS_8TeV_LLP::photonEffMedium(double pt,
                                             double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::electronRecEff(double pt,
                                            double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::electronIDEffMedium(double pt,
                                               double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::electronIDEffTightOverMedium(double pt,
                                                        double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::muonEffCombOverCombPlus(double phi,
                                                     double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::muonEffCombPlus(double phi,
                                             double eta) {
    // TODO This is to ensure compatibility with CM1, but should
    // be retested and removed at some point
    phi = 0;
...
double AnalysisHandlerATLAS_8TeV_LLP::tauSigEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::tauSigEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::tauSigEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::tauSigEffMultiLoose(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_8TeV_LLP::tauSigEffMultiMedium(double pt,
                                                  double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_8TeV_LLP::tauSigEffMultiTight(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffMultiLoose(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffMultiMedium(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::tauBkgEffMultiTight(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS_8TeV_LLP::bSigEff(double pt,
                                     double eta,
                                     double eff) {
...
double AnalysisHandlerATLAS_8TeV_LLP::bBkgCJetRej(double eff) {
...
double AnalysisHandlerATLAS_8TeV_LLP::bBkgCJetEff(double pt,
                                         double eta,
                                         double eff) {
...
double AnalysisHandlerATLAS_8TeV_LLP::bBkgLJetRej(double eff) {
...
double AnalysisHandlerATLAS_8TeV_LLP::bBkgLJetEff(double pt,
                                         double eta,
                                         double eff) {
...
const AnalysisHandlerATLAS_8TeV_LLP::muonDetector AnalysisHandlerATLAS_8TeV_LLP::detMap[53][21] = {{cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla},
        ...
        {cscsm, endsm, endsm, endsm, endsm, endsm, endsm, trans, barla, barla, barla, barla, barla, trans, endsm, endsm, endsm, endsm, endsm, endsm, cscsm},
        {cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla}};
const double AnalysisHandlerATLAS_8TeV_LLP::etaProj[21] = {-2.005, -1.955, -1.709, -1.411, -1.238, -1.163, -1.113, -0.965, -0.817, -0.519, 0.519, 0.817, 0.965, 1.113, 1.163, 1.238, 1.411, 1.709, 1.955, 2.005, 2.500};
const double AnalysisHandlerATLAS_8TeV_LLP::phiProj[53] = {3.142, 3.009, 2.948, 2.849, 2.629, 2.529, 2.471, 2.210, 2.174, 2.065, 1.855, 1.745, 1.695, 1.436, 1.386, 1.276, 1.066, 0.957, 0.916, 0.657, 0.596, 0.496, 0.277, 0.178, 0.142, -0.142, -0.178, -0.277, -0.496, -0.596, -0.657, -0.916, -0.957, -1.018, -1.066, -1.276, -1.357, -1.386, -1.436, -1.695, -1.745, -1.797, -1.855, -2.065, -2.134, -2.174, -2.210, -2.471, -2.529, -2.629, -2.849, -2.948, -3.009};

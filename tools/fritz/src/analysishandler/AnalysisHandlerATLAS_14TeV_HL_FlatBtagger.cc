/*
 * AnalysisHandlerATLAS_14TeV_HL_FlatBtagger.cc
 *
...
const double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::DR_TAU_TRACK = 0.2;
const double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::PTMIN_TAU_TRACK = 1.0;

const double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::DR_TAU_TRUTH = 0.2;
const double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::ETAMAX_TAU_TRUTH = 2.5;
const double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::PTMIN_TAU_TRUTH = 10.0;

const double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::DR_B_TRUTH = 0.4;
const double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::ETAMAX_B_TRUTH = 2.5;
const double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::PTMIN_B_TRUTH = 1.0;

AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::AnalysisHandlerATLAS_14TeV_HL_FlatBtagger() : AnalysisHandler() {
}

AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::~AnalysisHandlerATLAS_14TeV_HL_FlatBtagger() {
}

void AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::initialize() {
}

void AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::finalize() {
}

void AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::bookAnalysis(std::string analysisName,
                                        Tag_Map whichTags,
    ...
    if (analysisName == "atl_phys_pub_2014_010_sbottom")
        a = new Atl_phys_pub_2014_010_sbottom();
    else //@@extracode@@
        Global::abort(name,
...
void AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::postProcessParticles() {
...
void AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::identifyPhotons() {
    double pEffMed = 0;
    Photon* cand = NULL;
...
void AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::identifyElectrons() {
...
void AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::identifyMuons()  {
...
void AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tagBJets() {
   ...
   for(int j = 0; j < jets.size(); j++) {
              ...
              if(true_b[b]->PT > PTMIN_B_TRUTH &&
                fabs(true_b[b]->Eta) < ETAMAX_B_TRUTH &&
                 true_b[b]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                  eff_function = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::bSigEff;
                  break;
              }
          }
              ...
              for(int c = 0; c < true_c.size(); c++) {
                  if(true_c[c]->PT > PTMIN_B_TRUTH &&
                     ...
                     true_c[c]->P4().DeltaR(cand->P4()) < DR_B_TRUTH) {
                      eff_function = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::bBkgCJetEff;
                      break;
                  }
              }
          }
          ...
          if (eff_function == NULL)
              eff_function = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::bBkgLJetEff;
...
void AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tagTauJets() {
    ...
    for(int j = 0; j < jets.size(); j++) {
       ...
       for(int t = 0; t < true_tau.size(); t++) {
           if(true_tau[t]->PT > PTMIN_TAU_TRUTH &&
              ...
              cand->P4().DeltaR(true_tau[t]->P4()) < DR_TAU_TRUTH) {
               if(prongs > 1) {
                   effFunLoose = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffMultiLoose;
                   effFunMedium = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffMultiMedium;
                   effFunTight = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffMultiTight;
               }
               else {
                   effFunLoose = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffSingleLoose;
                   effFunMedium = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffSingleMedium;
                   effFunTight = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffSingleTight;
               }
               break;
           }
       }
       ...
       if(effFunLoose == NULL) {
           if(prongs > 1) {
               effFunLoose = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffMultiLoose;
               effFunMedium = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffMultiMedium;
               effFunTight = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffMultiTight;
           }
           else {
               effFunLoose = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffSingleLoose;
               effFunMedium = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffSingleMedium;
               effFunTight = &AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffSingleTight;
           }
       }
       // Now that we know the right function to use, lets tag
...
void AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::linkObjects() {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::photonEffMedium(double pt,
                                             double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::electronRecEff(double pt,
                                            double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::electronIDEffMedium(double pt,
                                               double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::electronIDEffTightOverMedium(double pt,
                                                        double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::muonEffCombOverCombPlus(double phi,
                                                     double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::muonEffCombPlus(double phi,
                                             double eta) {
    // TODO This is to ensure compatibility with CM1, but should
    // be retested and removed at some point
    phi = 0;
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffMultiLoose(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffMultiMedium(double pt,
                                                  double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauSigEffMultiTight(double pt,
                                                 double eta) {
    const double x0 = 15;
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffSingleLoose(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffSingleMedium(double pt,
                                                   double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffSingleTight(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffMultiLoose(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffMultiMedium(double pt,
                                                  double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::tauBkgEffMultiTight(double pt,
                                                 double eta) {
...
double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::bSigEff(double pt, double eta, double eff) {
    return eff;
}


double bBkgCJetRejBEff(double eff) {
    double a = -6.48209368;
    double b = 13.42998625;
    double c = -13.32689127;
    double d = 6.40071546;
    return exp(a*pow(eff,3)+b*pow(eff,2)+c*eff+d);
}


double bBkgCJetRejPt(double pt) {
    if (pt<=110) {
        return 4.553 + pow(((110-pt)*0.0158),2);
    } else {
        if (pt<=254.69) {
            return 4.55 + pow(((pt-120)*0.00548),2);
        } else {
            return 8.7-6*exp(-pt/500);
        }
    }
}

double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::bBkgCJetEff(double pt,
                                         double eta,
                                         double eff) {
    return bBkgCJetRejBEff(0.7) / bBkgCJetRejBEff(eff) / bBkgCJetRejPt(pt);
}

double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::bBkgLJetRej(double eff) {
...
double bBkgLightJetRejBEff(double eff) {
    double a = -19.87101569;
    double b = 41.1903122;
    double c = -40.29197117;
    double d = 18.99468773;
    return exp(a*pow(eff,3)+b*pow(eff,2)+c*eff+d);
}

double bBkgLightJetRejPtEE(double pt) {
    return (6.9*pow(pt,0.93)*exp(-0.13*pow(pt,0.55)) + 11.88);
}

double bBkgLightJetRejPt(double pt) {
    return bBkgLightJetRejPtEE(pt)/0.7;
}

double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::bBkgLJetEff(double pt,
                                         double eta,
                                         double eff) {
    return bBkgLightJetRejBEff(0.7) /
        bBkgLightJetRejBEff(eff) / bBkgLightJetRejPt(pt);
}


const AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::muonDetector AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::detMap[53][21] = {{cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla},
        ...
        {cscsm, endsm, endsm, endsm, endsm, endsm, endsm, trans, barla, barla, barla, barla, barla, trans, endsm, endsm, endsm, endsm, endsm, endsm, cscsm},
        {cscla, endla, endla, endla, endla, endla, endla, trans, barla, barla, barla, barla, barla, trans, endla, endla, endla, endla, endla, endla, cscla}};
const double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::etaProj[21] = {-2.005, -1.955, -1.709, -1.411, -1.238, -1.163, -1.113, -0.965, -0.817, -0.519, 0.519, 0.817, 0.965, 1.113, 1.163, 1.238, 1.411, 1.709, 1.955, 2.005, 2.500};
const double AnalysisHandlerATLAS_14TeV_HL_FlatBtagger::phiProj[53] = {3.142, 3.009, 2.948, 2.849, 2.629, 2.529, 2.471, 2.210, 2.174, 2.065, 1.855, 1.745, 1.695, 1.436, 1.386, 1.276, 1.066, 0.957, 0.916, 0.657, 0.596, 0.496, 0.277, 0.178, 0.142, -0.142, -0.178, -0.277, -0.496, -0.596, -0.657, -0.916, -0.957, -1.018, -1.066, -1.276, -1.357, -1.386, -1.436, -1.695, -1.745, -1.797, -1.855, -2.065, -2.134, -2.174, -2.210, -2.471, -2.529, -2.629, -2.849, -2.948, -3.009};

...
void AnalysisHandlerATLAS_13TeV::bookAnalysis(std::string analysisName,
    ...
    else if(analysisName == "atlas_2103_11684")
        a = new Atlas_2103_11684();
    else if(analysisName == "atlas_2004_10894")
        a = new Atlas_2004_10894();
    else if(analysisName == "atlas_2106_09609")
    ...
    else if(analysisName == "atlas_2010_14293")
    ...
    else if(analysisName == "atlas_2506_15515")
        a = new Atlas_2506_15515();
    else //@@extracode@@
        Global::abort(name,

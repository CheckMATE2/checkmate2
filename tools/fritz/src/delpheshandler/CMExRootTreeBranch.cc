...
CMExRootTreeBranch::CMExRootTreeBranch(const char *name, TClass *cl, TTree *tree) :
...
CMExRootTreeBranch::~CMExRootTreeBranch()
{
...
TObject *CMExRootTreeBranch::NewEntry()
{
  if(!fData) return 0;

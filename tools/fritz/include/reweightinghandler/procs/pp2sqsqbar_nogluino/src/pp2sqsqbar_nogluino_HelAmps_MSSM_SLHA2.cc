...
#include "pp2sqsqbar_nogluino_HelAmps_MSSM_SLHA2.h"
#include <complex> 
#include <cmath> 
#include <iostream> 
#include <cstdlib> 
    ...
    & vertex)
{
  ...
  TMP2 = (V1[2] * P3[0] - V1[3] * P3[1] - V1[4] * P3[2] - V1[5] * P3[3]); 
  vertex = COUP * S2[2] * S3[2] * (-cI * (TMP1) + cI * (TMP2)); 
}
    ...
    std::complex<double> COUP, double M2, double W2, std::complex<double> S2[])
{
  ...
  denom = COUP/((P2[0] * P2[0]) - (P2[1] * P2[1]) - (P2[2] * P2[2]) - (P2[3] *
      P2[3]) - M2 * (M2 - cI * W2));
  S2[2] = denom * S3[2] * (-cI * (TMP2) + cI * (TMP1)); 
}
    ...
    std::complex<double> COUP, double M1, double W1, std::complex<double> V1[])
{
  ...
  TMP4 = (P2[0] * V3[2] - P2[1] * V3[3] - P2[2] * V3[4] - P2[3] * V3[5]); 
  TMP7 = (V2[2] * V3[2] - V2[3] * V3[3] - V2[4] * V3[4] - V2[5] * V3[5]); 
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> S3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  S3[2] = denom * S2[2] * (-cI * (TMP2) + cI * (TMP1)); 
}


}  // end namespace $(namespace)s_MSSM_SLHA2

/*
 * AnalysisHandlerATLAS.h
 *
 *  Created on: Feb 23, 2015
 *      Author: daschm
 */

#ifndef ANALYSISHANDLERATLAS_H_
#define ANALYSISHANDLERATLAS_H_
...
class AnalysisHandlerATLAS : public AnalysisHandler {

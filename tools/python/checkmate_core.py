 ...
 \____|_| |_|\___|\___|_|\_\_|  |_/_/   \_\_| |_____|_____|
  """
    ...
    def user_param_check(self):
        ...
        if Info.parameters['llpPIDs'] != []:
            AdvPrint.cout("\t - The following PIDs will be considered as long-lived for the detector: "+str(Info.parameters['llpPIDs']).translate(None, "[]'"))

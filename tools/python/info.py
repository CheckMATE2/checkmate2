...
class Info(dict):
    ...
    def init(cls,config_paths):        
        ...
        cls.detector_setups = {
                "ATLAS": {
                    ...
                    13.0: {"default": ("atlas13tev", "ATLAS_13TeV"),
                           "LLP": ("atlas13tevllp","ATLAS_13TeV_LLP")},
                    14.0: {
                ...
                "CMS": {
                    ...
                    13.0: {"default": ("cms13tev", "CMS_13TeV"),
                           "LLP": ("atlas13tevllp","CMS_13TeV_LLP")},
        ...
        cls.analysis_handlers = {
                ...
                "cms8tevllp": "AnalysisHandlerCMS_8TeV_LLP",
    ...
    def parse_arguments(cls, emptyparser=False):       
        ...
        parser.add_argument('-invpids', '--invisible-pids', dest='invpids', default="", help='PIDs for BSM particles that should be considered invisible for the detector (separate with ,)')        parser.add_argument('-llppids', '--llp-pids', dest='llppids', default="", help='PIDs for BSM particles that should be considered LLPs for the detector (separate with ,)')              
    ...
    def fill_info_from_args(cls, args):
        ...
        if args.llppids != "":
           try:
              cls.parameters['LLPPIDs'] = [int(x) for x in args.llppids.split(",")]
           except ValueError:
              AdvPrint.cerr_exit("LLP PIDs are in wrong format. Must be integer numbers, split by ','")
